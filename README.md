...
# Steps to record the WhatsApp voice call  
  ...
  5. Start the voice call  
  6. Talk  
  7. End the voice call  
  8. The recording file will be created inside /data/data/com.whatsapp/cache/voip folder  
    - The file name should be like : {random-string}-{date-time}  
  9. Copy that file manually using `adb pull` command to your Linux/Mac/Windows machine  
...
# Steps to build the Magisk module agent-mcs.zip  
